...
#Make data loader:
state = 36
splitter = TrainTestSplitter(test_size=0.1, random_state=state, stratify=df.tissue_anno.values,
...
fn= Path('/ix/rbao/Projects/panCancer_HE/results/models/densenet169_bs%d_n%d/' % (batch_size,df.shape[0]))
