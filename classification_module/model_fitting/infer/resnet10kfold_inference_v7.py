...
fitted_model_path = train_path.joinpath(
    "%s/fold_models" % use_model
)  # Path must already exist
csv_path = infer_path.joinpath(
    "%s/csv" % use_model
)  # created by make_crossval_csv_v7.py
pred_csv_path = infer_path.joinpath(
    "%s/infer_csv" % use_model
