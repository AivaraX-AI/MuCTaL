...
split_data_path = Path(sys.argv[1])  #infer_data_path v{n}/tiles/'224px' or blah/'500px' etc. but will assume [vn]/parse/[type] for version and type
...
use_model = trained_model_path.parent.parts[-1]  #aka run_name i.e. "resnet18_jackknife", "resnet18_10fold_10rep_500bal_5ft", resnet18_2train_100rep_25bal  
...
pred_csv_path = data_root.joinpath(model_path).joinpath(use_model).joinpath('infer_csv') #Path can be new path if new data
