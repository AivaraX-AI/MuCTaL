'''
                ...
                e.g. 'resnet18_10fold_10rep_500bal_224px'
                    ...
                    -cv method = '10fold' k-fold cross validation (10 is parsed),
                                '2train' (4,8,..n train) limits training to tiles
                                 drawn from n training targets (digit is parsed)
    ...
    ver = tiles_v1 - consider use case where targets and / or cases are unavailable (public datasets)
             - tile set may contain multiple file types (tif jpeg jpg png etc)
             -  sys.argv[3] should be 2 parts now: 'crossvalid_target' or 'crossvalid_tiles'
