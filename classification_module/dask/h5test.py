...
if __name__ == '__main__':
    ...
    cluster = LocalCluster(n_workers=4, #32 works well, 64 --> maxes things out and very slow on 1 node
                            threads_per_worker=16,
                            memory_limit='32g',
                            dashboard_address=':8788',) #This works to set dask port, connect locally with ssh tunnel:
    ...
    tissue_detect = TissueDetectionHE(mask_name='tissue',outer_contours_only= True, blur_ksize=21,threshold = 20)
